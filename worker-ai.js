...
<a class="hey-woodrick-float" href="/voice-design-assistant.html?new=1" aria-label="Start a new Hey Woodrick design" title="Hey Woodrick — Start New Design"><span class="hey-woodrick-mic">🎙</span><span>HEY WOODRICK<small>Start New Design</small></span></a><script>(function(){var w=document.querySelector('.hey-woodrick-float'),n=document.getElementById('woodrickGlobalNav');if(w&&n){w.classList.add('nav-integrated');n.appendChild(w)}})();<\/script>`;
