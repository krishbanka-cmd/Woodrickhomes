...
.hey-woodrick-float{position:fixed;left:18px;bottom:22px;z-index:9999;display:flex;align-items:center;gap:10px;padding:10px 15px 10px 10px;border:1px solid #d6aa4f;border-radius:999px;background:#090909;color:#f0c96b!important;text-decoration:none!important;font:800 12px/1 Arial,sans-serif;letter-spacing:.02em;box-shadow:0 12px 34px rgba(0,0,0,.28);transition:transform .2s ease,box-shadow .2s ease}.hey-woodrick-float.nav-integrated{position:static;width:auto;height:44px;margin:0 0 0 2px;padding:4px 11px 4px 5px;gap:7px;box-shadow:none}.hey-woodrick-float.nav-integrated .hey-woodrick-mic{width:30px;height:30px;font-size:14px;box-shadow:none}.hey-woodrick-float.nav-integrated>span:last-child{display:block;font-size:10px}.hey-woodrick-float.nav-integrated small{display:block;font-size:8px}.hey-woodrick-float.nav-integrated.home-integrated{height:28px;padding:2px 8px 2px 3px;margin-left:auto}.hey-woodrick-float.nav-integrated.home-integrated .hey-woodrick-mic{width:22px;height:22px;font-size:11px}.hey-woodrick-float.nav-integrated.home-integrated>span:last-child{font-size:9px}.hey-woodrick-float.nav-integrated.home-integrated small{display:none}.woodrick-home-nav-clean .float-actions{display:none!important}.hey-woodrick-float:hover{transform:translateY(-2px);box-shadow:0 16px 38px rgba(0,0,0,.34)}.hey-woodrick-mic{width:38px;height:38px;border-radius:50%;display:grid;place-items:center;background:linear-gradient(145deg,#d5a338,#f0c96b);color:#111;font-size:19px;box-shadow:0 0 0 5px rgba(240,201,107,.10)}.hey-woodrick-float small{display:block;margin-top:3px;color:#d9ccb0;font-size:9px;font-weight:600;letter-spacing:0}.voice-arrival{margin:0 0 18px;padding:12px 14px;border-left:3px solid #c59a58;background:#fff8e8;color:#5c4931;font:700 12px/1.5 Arial,sans-serif;border-radius:4px}@media(max-width:520px){.hey-woodrick-float{left:10px;right:auto;bottom:18px;padding:8px 11px 8px 8px}.hey-woodrick-mic{width:34px;height:34px;font-size:17px}.hey-woodrick-float small{display:none}}
</style>
<a class="hey-woodrick-float" href="/voice-design-assistant.html?new=1" aria-label="Start a new Hey Woodrick design" title="Hey Woodrick — Start New Design"><span class="hey-woodrick-mic">🎙</span><span>HEY WOODRICK<small>Start New Design</small></span></a><script>(function(){var w=document.querySelector('.hey-woodrick-float'),n=document.getElementById('woodrickGlobalNav');if(w&&n){w.classList.add('nav-integrated');var a=n.querySelector('.woodrick-global-actions');n.insertBefore(w,a||null)}else if(w&&(location.pathname==='/'||location.pathname==='/index.html')){var t=document.querySelector('.nav-inner');if(t){document.body.classList.add('woodrick-home-nav-clean');w.classList.add('nav-integrated','home-integrated');var m=t.querySelector('.mobile-menu');t.insertBefore(w,m||null)}}})();<\/script>`;
