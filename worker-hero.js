...
.hero .btn-outline{background:rgba(13,11,9,.62)!important;color:#fff2c9!important;border-color:#c99738!important;backdrop-filter:blur(4px)!important}.hero .btn-outline:hover{background:#b9852d!important;color:#fff!important}
.hero .trust{color:#fff3d2!important;margin-top:30px!important;background:rgba(8,8,8,.58)!important;border:1px solid rgba(215,179,106,.28)!important;padding:10px 14px!important;max-width:max-content!important;backdrop-filter:blur(6px)!important}.hero .trust span{color:#fff3d2!important;font-weight:700!important}.hero .trust span::before{color:#f0c96b!important}
.hero .premium-proof{display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;max-width:720px!important;margin-top:16px!important;background:rgba(7,7,7,.76)!important;border:1px solid rgba(215,179,106,.42)!important;border-radius:4px!important;backdrop-filter:blur(8px)!important;box-shadow:0 12px 30px rgba(0,0,0,.20)!important;overflow:hidden!important}
.hero .premium-proof div{padding:15px 18px!important;border-right:1px solid rgba(215,179,106,.25)!important}.hero .premium-proof div:last-child{border-right:0!important}
.hero .premium-proof strong{display:block!important;color:#fff!important;font-size:21px!important;line-height:1.15!important;text-shadow:0 1px 5px rgba(0,0,0,.35)!important}.hero .premium-proof small{display:block!important;color:#f0c96b!important;font-size:10px!important;font-weight:800!important;letter-spacing:.12em!important;text-transform:uppercase!important;margin-top:7px!important}
.hero-material-tags{display:none!important}
@media(max-width:850px){.nav-inner{background:transparent!important}.nav .menu{background:#11100e!important}.hero{min-height:750px!important;background:linear-gradient(90deg,rgba(7,7,7,.90) 0%,rgba(10,10,10,.76) 58%,rgba(15,13,11,.34) 100%),url('https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=1500&q=88') 62% center/cover!important}.hero-content{padding-top:190px!important;max-width:580px!important}.hero h1{font-size:47px!important}.hero .premium-proof strong{font-size:18px!important}.hero .premium-proof div{padding:13px 12px!important}}
@media(max-width:520px){.hero{min-height:700px!important;background:linear-gradient(90deg,rgba(7,7,7,.92) 0%,rgba(10,10,10,.80) 68%,rgba(15,13,11,.42) 100%),url('https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=1100&q=86') 66% center/cover!important}.hero-content{padding-top:170px!important}.hero h1{font-size:39px!important}.hero p{font-size:14px!important}.hero .btn{padding:11px 12px!important;font-size:9px!important}.hero .premium-proof{grid-template-columns:1fr!important}.hero .premium-proof div{border-right:0!important;border-bottom:1px solid rgba(215,179,106,.22)!important}.hero .premium-proof div:last-child{border-bottom:0!important}.hero .premium-proof strong{font-size:17px!important}.hero .premium-proof small{font-size:9px!important}}
</style>`;
