...
.hero{min-height:790px!important;color:#fff!important;background:linear-gradient(90deg,rgba(8,8,7,.82) 0%,rgba(12,11,9,.63) 31%,rgba(18,15,12,.16) 58%,rgba(18,15,12,.03) 100%),url('/hero-premium.jpg') center/cover!important;overflow:hidden!important}
...
@media(max-width:850px){.nav-inner{background:transparent!important}.nav .menu{background:#11100e!important}.hero{min-height:760px!important;background:linear-gradient(90deg,rgba(8,8,7,.86) 0%,rgba(12,10,8,.66) 52%,rgba(18,15,12,.16) 100%),url('/hero-premium.jpg') 64% center/cover!important}.hero-content{padding-top:195px!important;max-width:560px!important}.hero h1{font-size:47px!important}.hero-material-tags{display:none!important}}
@media(max-width:520px){.hero{min-height:720px!important;background:linear-gradient(90deg,rgba(8,8,7,.88) 0%,rgba(12,10,8,.70) 68%,rgba(18,15,12,.22) 100%),url('/hero-premium.jpg') 68% center/cover!important}.hero-content{padding-top:175px!important}.hero h1{font-size:39px!important}.hero p{font-size:14px!important}.hero .btn{padding:12px 13px!important;font-size:10px!important}}
</style>`;
