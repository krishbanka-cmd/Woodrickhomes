...
.hero{height:calc(100svh - 92px)!important;min-height:580px!important;color:#fff!important;background:linear-gradient(90deg,rgba(7,7,7,.86) 0%,rgba(10,10,10,.73) 34%,rgba(15,13,11,.45) 56%,rgba(15,13,11,.20) 100%),url('https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=2200&q=90') center/cover!important;overflow:hidden!important}
...
.hero h1{color:#fff!important;text-shadow:0 2px 12px rgba(0,0,0,.30)!important;font-size:clamp(40px,3.8vw,52px)!important;line-height:1.03!important;max-width:660px!important}.hero h1 em{color:#d5a13c!important}
