...
.live-grid{align-items:start!important}.hierarchy-back{grid-column:1/-1!important;justify-self:start!important}.media-preview img,.pdf-cover{object-fit:contain!important;object-position:center center!important}
</style>
...
function card(g){
  ...
  else if(pdf)preview=(cover?'<img class="pdf-cover" loading="lazy" decoding="async" src="'+esc(cover)+'" data-cover-fallback="'+esc(automaticCover(pdf))+'" data-pdf="'+esc(mediaUrl(pdf))+'" alt="'+esc(g.catalogue)+' cover">':'<div class="pdf-cover-fallback">PDF CATALOGUE</div>')+'<div class="cover-title">'+esc(g.catalogue)+'</div>';
